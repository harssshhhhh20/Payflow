...
public class PaymentServiceImpl implements PaymentService {
    ...
    public ApiResponse<CreatePaymentResponse> createPayment(
        ...
        Timer.Sample sample = paymentMetricsService.startPaymentProcessing();
        try{
    ...
    public ApiResponse<CreatePaymentResponse> getPayment(
        ...
        String authenticatedMerchantId = authenticatedMerchantProvider.getAuthenticatedMerchant().getMerchantId();
